...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=Mpluya&repo=tsc-app"
}
```
## Log
```
...
┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->tsc-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[1].validated.transformations[8].sources[1].validated.transformations[1].then (Let)
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=tsc-app'
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[1].validated.transformations[8].sources[1].validated.transformations[1].then.in.apply (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(OpenRewriteRecipe, OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ╺ engine.transformations[1].validated.transformations[8].sources[1].validated.transformations[1].then.in.apply.transformations[0] (OpenRewriteRecipe)
┃ ┃ ┃ ┗ ┗ ┗ ┗ ┗ ╺ engine.transformations[1].validated.transformations[8].sources[1].validated.transformations[1].then.in.apply.transformations[1] (OpenRewriteRecipe)
